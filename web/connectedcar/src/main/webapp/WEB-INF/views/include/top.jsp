		...
		<div class="container">
			<div class="navbar-header">
				...
				<form action="/connectedcar/sales/loadData.do" method="post">
					<Input type="submit" class="navbar-brand" value="Carnect" style="border: 0; outline: 0; background-color: transparent; color: #ffffff;"/>
				</form>
			</div>
			<div class="navbar-collapse collapse navbar-right" style="margin-top: 12px;">
				<ul class="nav navbar-nav">
					<li class="active">
						<form action="/connectedcar/sales/loadData.do" method="post">
							<Input type="submit" value="MAIN" style="border: 0; outline: 0; background-color: transparent; color: #ffffff; padding: 10px"/>
						</form>
					</li>
